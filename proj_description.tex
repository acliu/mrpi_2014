...
%At $z>8$, 21~cm emission may be the only precise probe of $\xHI$.
...
%SF: It would be nice to include the following as a caveat, we probably don't
%have space While the latter is consistent with the astrophysical constraints,
%matching WMAP measurements requires assuming substantial star formation to $z
%\sim 30$.
...
%\Caption{-0.2in}{0.99}{-0.2in}{\small 
...
a simulated reionization field \Mycitep{mcquinn_et_al2007} with a 100-hour observation.
...
%JCP: Parsons 2012a seems like an odd cite here... Parsons 2010? ARP: it describes config for 128, which is fine.
...
%JCP: is this the signal delay between antennas or within an antenna? ARP: both!
